      ...
      <div className="hire__navbar-links">
        ...
        <div className="hire__navbar-button_container">
          <div className="hire__navbar-log">
            <Link to="/loginMain"><button type="button">Log In</button></Link>
          </div>
          <div className="hire__navbar-sign">
            <Link to="/signupMain"><button type="button">Sign Up</button></Link>
          </div>
          <div className="hire__navbar-menu">
            {toggleMenu 
              ? <RiCloseLine color="#393E46" size={27} onClick={() => setToggleMenu(false)}/>
              : <RiMenu3Line color="#393E46" size={27} onClick={() => setToggleMenu(true)}/>
             }
             {toggleMenu && (
              <div className="hire__navbar-menu_container scale-up-center">
                ...
                <Link to="/loginMain">
                <button type="button">Log In</button></Link>
                </div>
